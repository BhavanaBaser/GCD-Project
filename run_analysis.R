...
## Initial steps
testdata <- read.table("C:/Users/poonam/Documents/R/dataforproject/UCI HAR Dataset/test/X_test.txt")
traindata <- read.table("C:/Users/poonam/Documents/R/dataforproject/UCI HAR Dataset/train/X_train.txt")

trainlabel <- read.table("C:/Users/poonam/Documents/R/dataforproject/UCI HAR Dataset/train/y_train.txt")
testlabel <- read.table("C:/Users/poonam/Documents/R/dataforproject/UCI HAR Dataset/test/y_test.txt")

subjecttrain <- read.table("C:/Users/poonam/Documents/R/dataforproject/UCI HAR Dataset/train/subject_train.txt")
subjecttest <- read.table("C:/Users/poonam/Documents/R/dataforproject/UCI HAR Dataset/test/subject_test.txt")

features <- read.table("C:/Users/poonam/Documents/R/dataforproject/UCI HAR Dataset/features.txt")
activitylabel <- read.table("C:/Users/poonam/Documents/R/dataforproject/UCI HAR Dataset/activity_labels.txt")
...
combinedtest <- cbind(xtest, testlabel, subjecttest)
combinedtrain <- cbind(xtrain, trainlabel, subjecttrain)
